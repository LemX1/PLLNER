...
def get_args():
    ...
    parser.add_argument('--data_dir', default='data/vote', type=str)

    parser.add_argument('--ent2id_dir', default='model', type=str)

    parser.add_argument('--naive_classifier_path', default='/root/partial_label_learning/out/naive_classifier/step-1500.pt', type=str)
    ...
    parser.add_argument('--use_leverage_weight', default=False, action='store_true')
    ...
    parser.add_argument('--n_weight_decay_step', default=-1, type=int,
                        help='n_weight will start decaying after this step.'
                             'if this value < 0, n_weight will not decay during the whole training')

    parser.add_argument('--n_weight_decay_rate', default=1, type=float)
    ...
    # other args
    parser.add_argument('--model', default='LW_Model', type=str, choices=['LW_Model', 'CRFModel', 'BERTClassifier', 'MixUp_LW_Model', 'CSIDN_model'])

    parser.add_argument('--naive_classifier_type', default='BERTClassifier', type=str)
